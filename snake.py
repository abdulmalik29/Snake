...
def moveFood():
    ...
    foodX = random.randint(0,width/snakeSize -1) * snakeSize
    foodY = random.randint(0,height/snakeSize -1) * snakeSize
...
def growSnake():
    ...
    snake.append(canvas.create_rectangle(0,0, snakeSize,snakeSize, fill="grey"))
...
def restartGame(window, canvas):
    global snake, score, direction, gameOver, width, snakeSize, height, scoreText, gameText
    gameOver = False
    time.sleep(1.5)
    canvas.delete("all")
    ...
    snake.append(canvas.create_rectangle(snakeSize, snakeSize,
                                        snakeSize * 2, snakeSize * 2, fill="black"))

    score = 0
    txt = "Score: " + str(score)
    scoreText = canvas.create_text(width/2, 14 , fill="white",
...
width = 15 * (2*snakeSize)
height = 15 * (2*snakeSize)
...
score = 0
txt = "Score: " + str(score)
scoreText = canvas.create_text(width/2, 15 , fill="white",
font="Times 20 italic bold", text=txt)
